...
2. **重點服務內容擴充**：「適合用於」加咗訃告、悼念冊；價錢註明「HK$300 / 一人 / 一張」；文字提及雙人合照 HK$600
3. **新增第 5 項服務「喪禮悼念册設計及製作」**：涵蓋生平紀念冊、生平傳記、喪禮悼念冊、安息禮拜小冊子、追思會小冊子；因為設計費因項目而異，CTA 用 WhatsApp 查詢代替固定價錢／訂購按鈕
4. 服務項目 grid 由 3 欄改做 2×2（因應加咗第 4 張卡），mobile 保持單欄
5. 新增 `assets/booklet.jpg`（悼念冊示範相）

全部改動已經本機測試：JSON-LD 結構化數據驗證通過、成頁滾動冇 JS error、payment badge／新卡片喺 desktop 同 mobile 都正常顯示。
